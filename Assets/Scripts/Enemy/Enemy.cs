...
public class Enemy : MonoBehaviour
{
    ...
    void Update()
    {
        Debug.Log("state : " + basicInfo.CurrentState);
    ...
    void HandleMove()
    {
        ...
        // TODO: 공격 받을 경우 플레이어를 추적하는 코드 추가
    ...
    void Attack()
    {
        Debug.Log("Attack Function Start");
        //basicInfo.CurrentState = BasicInfo.State.Attack;
        basicInfo.IsTracing = false;
        basicInfo.IsMoving = false;
        basicComponents.Animator.SetBool("isMoving", basicInfo.IsMoving);
        ...
        Debug.Log("IsTracing : " + basicInfo.IsTracing);
        Debug.Log("IsMoving : " + basicInfo.IsMoving);
        ...
        if (!detection.IsTeleporting)
        {
            ...
            StartChargeEffect();
            Debug.Log("Finish TeleportAndShake Coroutine");
            Debug.Log("Finish StartChargeEffect Coroutine");
        }
    }

    private IEnumerator TeleportAndShake(Vector2 targetPos, Vector2 returnPos)
    {
        Debug.Log("Start TeleportAndShake Coroutine");
        ...
        Debug.Log("Finish CameraShake Coroutine");
    ...
    {
        Debug.Log(" CameraShake Coroutine");
    ...
    {
        Debug.Log("StartChargeEffect Coroutine");
